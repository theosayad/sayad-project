...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fdfaf6] text-stone-900 selection:bg-aleppo/20 overflow-x-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 px-4">
          ...
          <div className="max-w-xl mx-auto mb-16 animate-fade-in opacity-0 [animation-delay:600ms] [animation-fill-mode:forwards]">
            ...
            <div className="flex items-center justify-center gap-4 text-stone-600">
              <div className="h-[0.5px] w-12 bg-stone-800"></div>
              <span className="text-[9px] uppercase tracking-[0.5em] font-bold opacity-40">Psalm 133:1</span>
              <div className="h-[0.5px] w-12 bg-stone-800"></div>
            </div>
          </div>
                      ...
                      >
                        <div>
                          <div className="flex items-center gap-3 mb-1">
                            ...
                            <span className="text-[9px] font-mono font-bold bg-stone-100 px-1.5 py-0.5 rounded text-stone-400">G{result.generation}</span>
                          </div>
      ...
      <footer className="py-16 md:py-24 text-center border-t border-stone-100 bg-white">
        <div className="max-w-2xl mx-auto px-6">
          <div className="mb-10 md:mb-12">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#1a1512] text-stone-100 p-8 md:p-10 rounded-[2rem] shadow-xl relative overflow-hidden block group"
            >
               <div className="absolute inset-0 opacity-10 card-pattern"></div>
               <div className="relative z-10">
                 ...
                 <span className="inline-block mt-6 text-[9px] font-bold uppercase tracking-[0.4em] text-aleppo">Join WhatsApp Community</span>
               </div>
            </a>
          </div>
          
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 text-[9px] text-stone-300 uppercase tracking-[0.2em] font-bold mt-12">
             <span>New York</span><span>New Jersey</span><span>Beirut</span><span>Dubai</span><span>Tampa</span><span>Berlin</span><span>Paris</span>
          </div>
          <div className="mt-12 text-[8px] text-stone-200 uppercase tracking-widest flex flex-col items-center gap-2">
            <span>Archive & bull; 2025</span>
            <span className="text-stone-300 font-light tracking-[0.5em]">Developed by <span className="font-bold">Theo Sayad</span></span>
          </div>
        </div>
      </footer>
    </div>
