...
const SIBLINGS_BASE: Omit<Sibling, 'childrenCount'>[] = [
  { id: "P03", name: "Edouard Sayad", migrationDestination: "Beirut", description: "A central figure of the Beirut branch, anchoring the family in the Lebanese capital while extending its reach globally." },
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fdfaf6] text-stone-900 selection:bg-aleppo/20 overflow-x-hidden">
      <header className="relative py-20 sm:py-24 md:py-48 px-4 bg-[#1a1512] text-stone-100 overflow-hidden">
        ...
        <div className="absolute top-7 left-10 z-20 text-[9px] text-stone-500 uppercase tracking-[0.5em] animate-fade-in hidden md:flex items-center gap-6">
          <a href={WHATSAPP_GROUP_LINK} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-3 py-1 bg-[#25D366]/10 text-[#25D366] rounded-full hover:bg-[#25D366]/20 transition-all border border-[#25D366]/20">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 px-4 -translate-y-4 sm:-translate-y-8 md:-translate-y-16">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-[10rem] font-normal italic mb-6 sm:mb-8 tracking-tighter text-white leading-[0.95] sm:leading-[0.82] animate-fade-in opacity-0 [animation-delay:400ms] [animation-fill-mode:forwards] drop-shadow-2xl">
            The Sayad Project
          </h1>
          ...
          <div className="lg:col-span-2 p-10 md:p-16 flex flex-col justify-center relative border-b lg:border-b-0 lg:border-r border-stone-800">
            ...
            <div className="relative z-10">
              ...
              <p className="text-stone-400 font-serif italic text-base md:text-lg leading-relaxed">
                "Across continents and generations, our story stays connected—one family, many paths, still finding each other."
              </p>
            </div>
          </div>
